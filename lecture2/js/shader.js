...
class Shader
{
    ...
    setArrayBuffer( name, buffer, num_components, normalized = false, stride = 0, offset = 0 )
    {
        const location = this.getAttributeLocation( name )

        this.gl.enableVertexAttribArray( location )
        this.gl.bindBuffer( this.gl.ARRAY_BUFFER, buffer )
        this.gl.vertexAttribPointer( location, num_components, this.gl.FLOAT, normalized, stride, offset )
